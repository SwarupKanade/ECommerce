  ...
  return (
    ...
    <div className="flex sm:flex-row items-center sm:justify-between flex-col">
        ...
        <a href="/" className="flex items-center mb-2 sm:mb-0">
            <span className="self-center tracking-[0.7rem] ml-3 font-bold uppercase sm:text-[27px] text-2xl text-white">PrimeHub</span>
        </a>
    ...
    <div className="flex flex-col-reverse sm:flex-row items-center sm:justify-between">
                ...
                {/* Change in <a href="/"  with your website homepage */}
        <span className="sm:text-base md:text-lg text-sm  sm:text-center text-gray-400">© {moment().format("YYYY")} <a href="/" className="hover:underline">PrimeHub</a>. All Rights Reserved.
        </span>
